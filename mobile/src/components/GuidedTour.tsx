...
const TOUR_STEPS: (TourStep | null)[] = [
  ...
  {
    title: 'Your Wallet',
    description: 'View your available balance here. Tap Add Funds to deposit or Withdraw to cash out.',
    spotlightY: 0.15,
    spotlightHeight: 0.2,
  ...
  {
    title: 'Quick Actions',
    description: 'Create pools, join existing ones, shop with Spend Now, or check your activity feed.',
    spotlightY: 0.38,
  ...
  {
    title: 'Your Pools',
    description: 'See your active pools at a glance. Tap any pool to view details, contribute, or manage it.',
    spotlightY: 0.56,
  ...
  {
    title: 'Navigation',
    description: 'Use the tabs to switch between Home, Pools, Wallet, Spend Now, and your Profile.',
    spotlightY: 0.92,
