  ...
  const handleAccept = () => {
    if (!selectedBankAccountId) {
      toast({
        ...
        description: "Please link a bank account first to receive the transfer.",
        variant: "destructive",
      });
      return;
    }
            ...
            <CardContent className="space-y-6">
              ...
              <div className="p-4 rounded-lg bg-white/5 border border-white/10 space-y-3">
                <div className="flex items-center gap-2">
                  ...
                  <span className="text-sm font-medium">Select Destination Bank Account</span>
                </div>
              ...
              <div className="flex items-start gap-2 p-3 rounded-lg bg-blue-500/10 border border-blue-500/20">
                ...
                <p className="text-xs text-blue-500">
                  Once accepted, funds typically arrive in your bank account within 1-3 business days.
                </p>
              </div>
