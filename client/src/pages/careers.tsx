    ...
    <Layout>
      <div className="max-w-4xl mx-auto py-12">
        ...
        <div className="bg-gradient-to-r from-primary/10 to-blue-500/10 rounded-2xl p-8 mb-12">
          <h2 className="text-2xl font-semibold mb-4">Why ChipInPool?</h2>
          <p className="text-muted-foreground leading-relaxed">
            We're a small but mighty team tackling big problems in the fintech space. At ChipInPool, you'll have the opportunity to work on products that directly impact how millions of people manage money together. We value creativity, ownership, and a bias for action.
          </p>
        </div>
        ...
        <div className="bg-card/50 border border-white/10 rounded-2xl p-8 text-center">
          ...
          <p className="text-muted-foreground mb-6">
            We're always looking for talented people. Send us your resume and tell us how you'd contribute to ChipInPool.
          </p>
